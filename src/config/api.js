 ...
 */
const API_BASE_URL = import.meta.env.VITE_API_URL?.replace(/\/$/, '') || 'https://offerverify.onrender.com';

if (!import.meta.env.VITE_API_URL && import.meta.env.PROD) {
  console.warn(
    '[OfferVerify] VITE_API_URL is not set in Vercel! Falling back to hardcoded Render URL.'
  );
}
